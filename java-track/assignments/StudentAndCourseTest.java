...
public class StudentAndCourseTest extends TestCase {
	...
	public void testStudentID() {
		Student s = new Student("Doug", "Shook", 12345);
		assertEquals(12345, s.getStudentID());
		}
	...
	public void testGetCourseCount() {
		Course c = new Course("History", 10, 20);
		assertEquals(1, Course.getCourseCount());
		}
	...
	public void testGetAllCourses() {
		...
		assertTrue(Course.getAllCourses().contains(h));
		assertTrue(Course.getAllCourses().contains(c));
		}
